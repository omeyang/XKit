...
完整公开 API 与稳定性列表见 [`docs/07-conventions/api.md`](docs/07-conventions/api.md)。
...
贡献流程、测试规范、Code Review 要点见 [`docs/07-conventions/contributing.md`](docs/07-conventions/contributing.md)。
...
| 类别 | 位置 |
|---|---|
| 总体目标 | [`docs/01-objectives.md`](docs/01-objectives.md) |
| 约束条件 | [`docs/02-constraints.md`](docs/02-constraints.md) |
| 业务场景 | [`docs/03-scenarios.md`](docs/03-scenarios.md) |
| 困难与挑战 | [`docs/04-challenges.md`](docs/04-challenges.md) |
| 关键决策（ADR） | [`docs/05-decisions/`](docs/05-decisions/00-index.md) |
| 进度追踪 | [`docs/06-progress.md`](docs/06-progress.md) |
| 约定规范（API/命名/贡献） | [`docs/07-conventions/`](docs/07-conventions/) |

...
| [xid](02-xid.md) | Sonyflake v2 分布式 ID 生成 | Stable | 99.1% |
| [xjson](03-xjson.md) | JSON 格式化（PrettyE 等） | Stable | 100.0% |
| [xkeylock](04-xkeylock.md) | 基于 key 的进程内互斥锁（分片 channel） | Stable | 100.0% |
| [xlru](05-xlru.md) | LRU 缓存（泛型 + TTL） | Stable | 100.0% |
| [xmac](06-xmac.md) | MAC 地址工具（多格式解析、`iter.Seq` 迭代） | Stable | 98.2% |
| [xnet](07-xnet.md) | IP 地址工具（net/netip + WireRange） | Stable | 98.4% |

...
func TestWrapEtcdError(t *testing.T) {
	tests := []struct {
		...
		{"nil", nil, nil, true},
		{"ErrLocked", concurrency.ErrLocked, ErrLockHeld, false},
		{"ErrSessionExpired", concurrency.ErrSessionExpired, ErrSessionExpired, false},
		{"ErrLockReleased", concurrency.ErrLockReleased, ErrNotLocked, false},
		{"context.Canceled", context.Canceled, context.Canceled, false},
		{"context.DeadlineExceeded", context.DeadlineExceeded, context.DeadlineExceeded, false},
		{"other error", errors.New("other"), nil, false},
	}
...
func TestWrapRedisError(t *testing.T) {
	tests := []struct {
		...
		{"context.Canceled", context.Canceled, context.Canceled, false},
		{"context.DeadlineExceeded", context.DeadlineExceeded, context.DeadlineExceeded, false},
		{"ErrTaken", &redsync.ErrTaken{}, ErrLockHeld, false},
		{"ErrFailed", redsync.ErrFailed, ErrLockFailed, false},
		{"ErrExtendFailed", redsync.ErrExtendFailed, ErrExtendFailed, false},
		{"ErrLockAlreadyExpired", redsync.ErrLockAlreadyExpired, ErrLockExpired, false},
		{"other error", errors.New("other"), nil, false},
	}
